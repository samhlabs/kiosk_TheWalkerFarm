...
omxplayer -o local --win '96 0 1920 1080' /media/PiShare/walkerfarm_1300x900.mov #launch the video // TO DO: replace this with variables for video and window size, or make easily replacable